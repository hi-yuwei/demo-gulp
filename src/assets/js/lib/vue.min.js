...
!(function (e, t) {
  ...
  function Ce(e, t) {
    ...
    if (o(e) && !(e instanceof pe))
      return (
        y(e, '__ob__') && e.__ob__ instanceof we ? (n = e.__ob__) : be && !te() && (Array.isArray(e) || s(e)) && Object.isExtensible(e) && !e._isVue && (n = new we(e)),
        t && n && n.vmCount++,
        n
      )
  }
  ...
  function rt(e, n, i, o, a, s) {
    ...
    for (c in e)
      (u = e[c]),
        ...
        t(u) ||
          (t(l)
            ? (t(u.fns) && (u = e[c] = nt(u, s)), r(f.once) && (u = e[c] = a(f.name, u, f.capture)), i(f.name, u, f.capture, f.passive, f.params))
            : u !== l && ((l.fns = u), (e[c] = l)))
      ...
      ? (function e(o, a) {
          ...
          for (c = 0; c < o.length; c++)
            t((u = o[c])) ||
              ...
              (f = s[l]),
              Array.isArray(u)
                ? u.length > 0 && (st((u = e(u, (a || '') + '_' + c))[0]) && st(f) && ((s[l] = he(f.text + u[0].text)), u.shift()), s.push.apply(s, u))
                : i(u)
                ? st(f)
                  ? (s[l] = he(f.text + u))
                  : '' !== u && s.push(he(u))
    ...
    inserted: function (e, t, n, r) {
      'select' === n.tag
        ...
        : ('textarea' === n.tag || Xn(e.type)) &&
          ...
          t.modifiers.lazy || (e.addEventListener('compositionstart', Zi), e.addEventListener('compositionend', Gi), e.addEventListener('change', Gi), W && (e.vmodel = !0)))
    },
        ...
        chars: function (e, t, n) {
          if (r && (!q || 'textarea' !== r.tag || r.attrsMap.placeholder !== e)) {
            var i,
              ...
              f = r.children
            if (
              (e = c || e.trim() ? ('script' === (i = r).tag || 'style' === i.tag ? e : sa(e)) : f.length ? (a ? ('condense' === a && oa.test(e) ? '' : ' ') : o ? ' ' : '') : '')
            )
                ...
                a &&
                  ...
                  a.sync &&
                    ...
                    c
                      ...
                      : (Mr(e, 'update:' + b(r), s, null, !1, 0, u[t]), C(r) !== b(r) && Mr(e, 'update:' + C(r), s, null, !1, 0, u[t])))),
  ...
  function Ja(e, t) {
    ...
    var r = e.slotScope === ca ? '' : String(e.slotScope),
      i =
        ...
        r +
        '){return ' +
        ('template' === e.tag ? (e.if && n ? '(' + e.if + ')?' + (qa(e, t) || 'undefined') + ':undefined' : qa(e, t) || 'undefined') : Ra(e, t)) +
        '}',
      o = r ? '' : ',proxy:true'
